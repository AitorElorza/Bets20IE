...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		this.setSize(new Dimension(565, 260));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("CreateQuery"));

		jComboBoxEvents.setModel(modelEvents);
		jComboBoxEvents.setBounds(new Rectangle(252, 47, 273, 20));
		jLabelListOfEvents.setBounds(new Rectangle(252, 15, 277, 20));
		jLabelQuery.setBounds(new Rectangle(252, 109, 75, 20));
		jTextFieldQuery.setBounds(new Rectangle(332, 109, 197, 20));
		jLabelMinBet.setBounds(new Rectangle(252, 140, 75, 20));
		jTextFieldPrice.setBounds(new Rectangle(332, 140, 60, 20));

		jCalendar.setBounds(new Rectangle(10, 50, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonCreate.setBounds(new Rectangle(252, 171, 130, 29));
		...
		jButtonClose.setBounds(new Rectangle(399, 171, 130, 29));
		...
		jLabelMsg.setBounds(new Rectangle(252, 78, 305, 20));
		...
		jLabelEventDate.setBounds(10, 13, 140, 25);
