...
public class CancelEventGUI extends JFrame {
	...
	private JButton jButtonCreate = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CEvent")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		this.setSize(new Dimension(264, 353));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("CEvent"));

		jComboBoxEvents.setModel(modelEvents);
		jComboBoxEvents.setBounds(new Rectangle(10, 240, 225, 20));
		jLabelListOfEvents.setBounds(new Rectangle(10, 209, 277, 20));

		jCalendar.setBounds(new Rectangle(10, 47, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonCreate.setBounds(new Rectangle(10, 271, 130, 30));
		...
		jButtonClose.setBounds(new Rectangle(150, 271, 85, 30));
		...
		jLabelMsg.setBounds(new Rectangle(275, 78, 305, 20));
		...
		jLabelEventDate.setBounds(10, 16, 140, 25);
